        ...
        <>
            ...
            >
                <section className="grid w-full max-w-5xl overflow-hidden rounded-[12px] border border-[#4B3D59] bg-[#FBF7ED] shadow-[0_28px_58px_#18102433] lg:grid-cols-[0.82fr_1.18fr]">
                    <aside
                        className="relative isolate min-h-36 overflow-hidden bg-[#181024] p-7 text-white sm:p-9 lg:min-h-[720px]"
                        style={{
                            backgroundImage:
                    ...
                    >
                        ...
                        <div className="absolute -bottom-14 -right-10 hidden h-52 w-40 -rotate-6 rounded-[10px] border border-[#C9BAD8] bg-[#FBF7ED] shadow-[0_18px_36px_#0D071466] lg:block">
                            <span className="absolute left-1/2 top-8 h-7 w-24 -translate-x-1/2 rotate-3 bg-[#A98BC4]/65" />
                    ...
                    >
                        ...
                        <h1 className="mt-8 font-display text-3xl font-bold tracking-[-0.03em] text-[#181024] sm:text-4xl">
                            Criar sua conta
                        </h1>
                        ...
                        <form className="mt-8 grid gap-4" onSubmit={submit}>
                            <label className="grid gap-2 text-sm font-bold text-[#181024]">
                                ...
                                <input
                                    ...
                                    value={data.name}
                                />
                                {errors.name && <span className="text-xs text-[#C8444B]">{errors.name}</span>}
                            </label>
                            ...
                            <button
                                className="mt-1 inline-flex min-h-12 items-center justify-center gap-2 rounded-[4px] border border-[#FF8E80] bg-[#FF705F] px-5 text-sm font-bold text-[#181024] shadow-[inset_0_-2px_0_#D95045] transition hover:-translate-y-px hover:bg-[#FF8273] disabled:opacity-60"
                                disabled={processing}
                                type="submit"
                            >
                        ...
                        <div className="mt-6 border-t border-[#D6CFDD] pt-6 text-sm">
                            <Link className="inline-flex items-center gap-2 font-bold text-[#D95045]" href={loginUrl}>
