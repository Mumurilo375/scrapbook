                    ...
                    {benefits.map((benefit) => {
                        ...
                        return (
                            <PaperCard className="p-5" key={benefit.title}>
                                <div className="flex h-11 w-11 items-center justify-center rounded-full border border-[#d8b98e] bg-[#f4e2c6] text-[#8E2F2F]">
                                    <Icon aria-hidden="true" className="h-5 w-5" />
                                </div>
                                <h3 className="mt-5 text-lg font-semibold text-[#3A2418]">{benefit.title}</h3>
                                <p className="mt-3 text-sm leading-6 text-[#6F4E37]">{benefit.description}</p>
                            </PaperCard>
                        );
                    })}
                </div>
