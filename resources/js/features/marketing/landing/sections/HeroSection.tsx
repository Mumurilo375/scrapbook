...
export function HeroSection() {
    return (
        <section className="relative overflow-hidden pb-16 pt-10 sm:pb-20 sm:pt-14 lg:pb-24 lg:pt-20" id="topo">
            <div className="absolute inset-x-0 top-0 h-px bg-[#E5D0B8]" />
            <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-[0.92fr_1.08fr] lg:gap-10 lg:px-8">
                <div className="relative z-10">
                    ...
                    <div className="mt-7 max-w-3xl">
                        <h1 className="text-balance text-4xl font-semibold leading-[1.05] text-[#1F150A] sm:text-5xl lg:text-6xl">
                            Crie um scrapbook digital para emocionar{' '}
                            <span className="relative inline-block">
                                <span className="font-hand text-[1.18em] font-semibold text-[#D93632]">
                                    quem você ama.
                                </span>
                                <span className="absolute -bottom-1 left-2 right-1 h-2 rounded-full bg-[#BD8558]/35" />
                            </span>
                        </h1>
                        <p className="mt-6 max-w-2xl text-lg leading-8 text-[#42291D] sm:text-xl">
                    ...
                    <div className="mt-8 max-w-xl rounded-[8px] border border-[#E5D0B8] bg-[#FFF7EE]/82 p-4 shadow-sm">
                        <div className="flex flex-wrap items-center gap-2 text-[#BD8558]" aria-label="Cinco estrelas">
                            {Array.from({ length: 5 }).map((_, index) => (
                                <Star aria-hidden="true" className="h-4 w-4 fill-current" key={index} />
                            ))}
                        </div>
                        <div className="mt-3 flex gap-3">
                            <Quote aria-hidden="true" className="mt-1 h-5 w-5 shrink-0 text-[#E66F65]" />
                            <p className="text-sm leading-6 text-[#42291D]">
