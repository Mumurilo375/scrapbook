...
export function DemoSection() {
    return (
        <section className="px-4 py-16 sm:px-6 sm:py-20 lg:px-8" id="demo">
            <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[8px] border border-[#42291D] bg-[#42291D] text-[#FFF7EE] shadow-[0_28px_70px_#221C193D]">
                ...
                <div className="relative grid gap-10 px-5 pb-8 pt-14 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:p-12 lg:pt-16">
                    <div className="flex flex-col justify-center">
                        ...
                        <p className="mt-5 max-w-2xl text-base leading-7 text-[#EAD2B8] sm:text-lg">
                        ...
                        <div className="mt-8">
                            <CTAButton className="border-[#FFF7EE]" href="/demo" icon="play" variant="light">
                                Explorar a demo
                            </CTAButton>
                        </div>
                    </div>
                    ...
                    <div className="relative min-h-[430px]">
                        ...
                        <div className="absolute bottom-16 left-4 max-w-[220px] rotate-[-4deg] rounded-[8px] border border-[#D9B17F] bg-[#BD8558] p-4 text-[#1F150A] shadow-xl">
                            <div className="flex items-center gap-2">
                                <PlayCircle aria-hidden="true" className="h-5 w-5 text-[#D93632]" />
                                <p className="font-hand text-2xl leading-none">toque para abrir</p>
                            </div>
                            <p className="mt-2 text-xs font-semibold uppercase tracking-[0.14em] text-[#42291D]">
                                link público preparado
                            </p>
                        </div>
                        <Sparkles aria-hidden="true" className="absolute right-12 top-16 h-8 w-8 text-[#BD8558]" />
                    </div>
                </div>
            </div>
        </section>
