...
export function GiftEditorLayout({ center, left, right }: GiftEditorLayoutProps) {
    return (
        <section className="mx-auto grid max-w-[1560px] gap-3 overflow-x-hidden px-2 py-3 sm:gap-4 sm:px-5 sm:py-4 lg:min-h-[calc(100vh-76px)] lg:grid-cols-[248px_minmax(0,1fr)_372px] lg:px-6">
