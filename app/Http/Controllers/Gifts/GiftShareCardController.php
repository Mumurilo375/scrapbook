...
{
    public function __invoke(Request $request, Gift $gift, GiftShareCardData $shareCardData): Response
    {
        return $this->render($request, $gift, $shareCardData, autoPrint: false);
    }

    public function download(Request $request, Gift $gift, GiftShareCardData $shareCardData): Response
    {
        return $this->render($request, $gift, $shareCardData, autoPrint: true);
    }

    private function render(Request $request, Gift $gift, GiftShareCardData $shareCardData, bool $autoPrint): Response
    {
