...
return [
    ...
    'analytics' => [
        ...
        'events_retention_days' => (int) env('SCRAPBOOK_ANALYTICS_EVENTS_RETENTION_DAYS', 180),
        'sessions_retention_days' => (int) env('SCRAPBOOK_ANALYTICS_SESSIONS_RETENTION_DAYS', 365),
        'gift_visits_retention_days' => (int) env('SCRAPBOOK_GIFT_VISITS_RETENTION_DAYS', 365),
        'gift_events_retention_days' => (int) env('SCRAPBOOK_GIFT_EVENTS_RETENTION_DAYS', 365),
        'daily_metrics_retention_days' => (int) env('SCRAPBOOK_ANALYTICS_DAILY_METRICS_RETENTION_DAYS', 1095),
        'keep_financial_events_forever' => (bool) env('SCRAPBOOK_ANALYTICS_KEEP_FINANCIAL_EVENTS_FOREVER', env('SCRAPBOOK_KEEP_FINANCIAL_EVENTS_FOREVER', true)),
    ],
];
